  ...
  return (
      <div className={ Styles.home }>
        <p>
          ...
          where I build apps and deliver ideas to the market using <IconLink iconSource={ JavaIcon } alt='Java' text='Java' link='https://dev.java/' />&nbsp;
        ...
        <p className={ Styles.paragraph }>
          ...
          I had some viable options in non software development area (or at least I thought they were viable at that time).
          But then I tried to start a professional career as a software engineer. It worked, and I liked it.
        </p>
        <p className={ Styles.paragraph }>
          Right now I am a Java-ecosystem software engineer.
